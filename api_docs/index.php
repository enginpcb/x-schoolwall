            ...
            <div class="content-menu">
                <ul>
                    ...
                    <li class="scroll-to-link <?php if($docs_page == 'gen_settings') { echo("active"); } ?>">
                        <a href="<?php echo cl_link("api_docs?page=gen_settings"); ?>">Update Profile</a>
                    </li>
                    ...
                    <li class="scroll-to-link <?php if($docs_page == 'messaging') { echo("active"); } ?>">
                        ...
                        <ul>
                            ...
                            <li class="scroll-to-link">
                                <a href="<?php echo cl_link("api_docs?page=messaging#delete-message"); ?>">4. Delete Message</a>
                            </li>
                            <li class="scroll-to-link">
                                <a href="<?php echo cl_link("api_docs?page=messaging#clear-chat"); ?>">5. Clear Chat</a>
                            </li>
                        </ul>
                    </li>
